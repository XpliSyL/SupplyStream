          ...
          <section id="intro" className="main">
            <div className="spotlight">
              <div className="content">
                ...
                <p>
                  Supply Stream has three dynamic and distinctive service offerings. Our objective is to share knowledge and expertise with our business partners, with particular focus on process improvements, demand management techniques and strategic sourcing concepts. Supply Stream focus is on continued growth by innovation and participation in long term partnerships.
                </p>
            ...
            <ul className="features">
              <li>
                ...
                <p>
                  ...
                  Our benchmarking of supplier services provides you the platform to accuratly assess market offerings and achieve the best possible outcomes.
                </p>
              </li>
              <li>
                ...
                <p>
                  Supply Stream has established strong and reliable relationships with local and international wholesale and manufacturing companies. Supply Stream can assist you achieve:
                    Significant cost benefits without protracted supplier negotiations.
                    Efficient supply and delivery of your product requirements.
                </p>
              </li>
              <li>
                ...
                <p>
                  Supply Stream offers a depth of product knowledge that facilitates innovative solutions to meet your sustainable and expenditure reduction requirements. Our service offering includes:
                    Range Reduction Stategies 
                    Sustainable Product Identification
                    Product Selection and Usage Awarness
                </p>
              </li>
            </ul>
